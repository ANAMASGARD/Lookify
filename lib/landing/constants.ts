...
export const CIRCLE_SYMBOLS = ["8", "$", "^^", "%", "/"] as const;

export const CAPTION_TEXT =
  "Full-stack AI fashion photo editor SaaS powered by YouCam API. Move your cursor left or right to scrub between looks — virtual try-on, makeup transfer, and beauty tools for brands and creators.";

export const ENTRY_EASE = [0.25, 0.1, 0.25, 1] as const;
